...
const faqList = [
  ...
  },
  {
    ...
    answer: "하루의 스트레스를 해소하고 리듬을 유지하기 위해, 저녁마다 짧은 인터벌 러닝이나 빠르게 걷는 루틴을 실천합니다.\n 꾸준한 운동이 집중력 유지와 감정 조절에 큰 도움이 되고 있습니다.",
  },
  {
    question: "# 협업 시 중요하게 생각하는 소통 방식은 무엇인가요?",
    answer: "작은 것도 명확하게 공유하려 노력하고, 이해를 돕기 위해 예시나 문서를 함께 제공합니다.\n 피드백을 먼저 요청하거나, 모호한 부분은 빠르게 질문하며 팀원 간의 흐름을 맞추려 노력합니다.",
  },
];
